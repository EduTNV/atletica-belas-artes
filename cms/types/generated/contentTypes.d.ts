...
export interface ApiConquistaConquista extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    medalha: Schema.Attribute.Enumeration<
      ['ouro', 'prata', 'bronze', 'premio']
    >;
...
export interface ApiEventoEvento extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    arte: Schema.Attribute.Media<'images'>;
    ...
    link_ingresso: Schema.Attribute.String;
    local: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::evento.evento'
...
export interface ApiResultadoResultado extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    adversario: Schema.Attribute.String & Schema.Attribute.Required;
    ...
    modalidade: Schema.Attribute.Relation<
      ...
      'api::modalidade.modalidade'
    >;
    placar_adversario: Schema.Attribute.Integer;
    placar_nos: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
